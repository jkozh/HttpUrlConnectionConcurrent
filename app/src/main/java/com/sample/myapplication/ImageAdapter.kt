...
class ImageAdapter : RecyclerView.Adapter<ImageAdapter.ImageViewHolder>() {
    ...
    override fun getItemId(position: Int): Long = URLS[position].hashCode().toLong()
    ...
    override fun onBindViewHolder(holder: ImageViewHolder, position: Int) {
        holder.bind(imageDownloader, URLS[position])
    }
    ...
    class ImageViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
        ...
        fun bind(imageDownloader: ImageDownloader, url: String) {
            imageView?.let { imageDownloader.download(url, it) }
        }
    }
}